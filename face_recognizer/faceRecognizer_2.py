...
test_image = face_recognition.load_image_file('/home/hualde-jetson/p_m_w/opencv_tutorial/face_recognizer/demoImages/unknown/u9.jpg')
...
while(True):
    ...
    for (top, right, bottom, left), face_encoding in zip(facePositions, allEncodings):
        ...
        cv2.putText(test_image,name,(left,top-6),font,1,(255,0,255),1)
        resized = cv2.resize(test_image, (480,320), interpolation = cv2.INTER_AREA)
