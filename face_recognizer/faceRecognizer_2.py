...
image_dir='/home/hualde-jetson/p_m_w/opencv_tutorial/face_recognizer/demoImages/known'
...
image_dir='/home/hualde-jetson/p_m_w/opencv_tutorial/face_recognizer/demoImages/unknown'
for root,dirs, files in os.walk(image_dir):
    for file in files:
        print(root)
        print(file)
